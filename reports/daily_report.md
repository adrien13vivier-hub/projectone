...
**EUR/USD :** 1 EUR = 1.1710 USD _(source : TwelveData)_

| Indice | Variation | Cours | Source |
|--------|-----------|-------|--------|
| S&P 500 | — +0.00% | 0.00 | ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:vide) |
| CAC 40 | — +0.00% | 0.00 | ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:vide) |
| Nikkei 225 | — +0.00% | 0.00 | ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:vide) |
...
📰 **Actualité :** CoreWeave Stock Is Gaining Today: What Does The Chart Show?
...
> Détail : ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:HTTP 403)
...
- ❌ Indice S&P 500 : ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:vide)
- ❌ Indice CAC 40 : ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:vide)
- ❌ Indice Nikkei 225 : ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:vide)
- ❌ Palantir Technologies historique : ❌ DONNÉES ERRONÉES — historique indisponible (EODHD:HTTP 402, Finnhub:HTTP 403)
- ❌ CoreWeave historique : ❌ DONNÉES ERRONÉES — historique indisponible (EODHD:HTTP 402, Finnhub:HTTP 403)
- ❌ Riot Platforms historique : ❌ DONNÉES ERRONÉES — historique indisponible (EODHD:HTTP 402, Finnhub:HTTP 403)
- ❌ JCDecaux cours : ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:HTTP 403)
- ❌ JCDecaux : cours totalement indisponible
- ❌ Crédit Agricole SA cours : ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:HTTP 403)
- ❌ Crédit Agricole SA : cours totalement indisponible
- ❌ Abionyx Pharma cours : ❌ DONNÉES ERRONÉES (EODHD:HTTP 402, Finnhub:HTTP 403)
- ❌ Abionyx Pharma : cours totalement indisponible
